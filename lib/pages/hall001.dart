...
class Hall001 extends StatefulWidget {
  const Hall001({Key? key}) : super(key: key);

  @override
  State<Hall001> createState() => _Hall001();
}

class _Hall001 extends State<Hall001> with TickerProviderStateMixin {
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      image: AssetImage("img/Map001.png"),
                      fit: BoxFit.cover,
                    )),
                  ),
                  //
                ...
                Row(
                  ...
                  children:[
                  // \n for line break
                  AppText(text: "Hall 001 is the Post Graduate Research \nCenter which is located on the RIGHT SIDE \nwhen enter to the Ground Floor using the \nmain entrance.",color: AppColors.mainTextColor,),
